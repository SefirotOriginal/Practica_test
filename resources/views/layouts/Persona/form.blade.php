                    ...
                    <form class="w-full h-full" method="POST" action="{{ route('persona.store') }}">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white " required type="text" placeholder="Jane" name="nombre" id="nombre" value="{{ old('nombre', $perso->nombre ?? '')}}">
                                @error('nombre')
                            ...
                            <div class="w-full md:w-1/2 px-3">
                                ...
                                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 " required type="text" placeholder="Doe" name="apellido" id="apellido" value="{{ old('apellido', $perso->apellido ?? '')}}">
                                @error('apellido')
                                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="w-full md:w-1/2 px-3">
                                ...
                                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="date" required name="fecha_nacimiento" id="fecha-nacimiento" value="{{ old('fecha_nacimiento', $fecha_nacimiento->fecha_nacimiento ?? '')}}">
                            ...
                            <div class="w-full md:w-1/2 px-3">
                                ...
                                <div class="relative">
                                    <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="genero" id="genero" required>
                                        ...
                                        <option value="F" @if(old('genero', $persona->genero ?? ))>Femenino</option>
